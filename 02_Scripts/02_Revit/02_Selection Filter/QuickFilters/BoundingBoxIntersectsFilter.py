...
#region Bounding Box Intersect Filter Filter
...
# This Filter accept a Inverse including true. This filter collects the elements that intersect with a BoundingBox
