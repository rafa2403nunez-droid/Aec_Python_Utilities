...
#region Element Id Set Filter

# Get Elements in the Revit Interface
try:
    selection = uidoc.Selection.PickElementsByRectangle("Select a Walls with Rectangle Selection: ")
except:
    TaskDialog.Show("Revit API", "Operation Cancelled")
    OUT = "Operation Canceled"

if not selection:
    OUT = "Id Collection is equal to None"
else:
