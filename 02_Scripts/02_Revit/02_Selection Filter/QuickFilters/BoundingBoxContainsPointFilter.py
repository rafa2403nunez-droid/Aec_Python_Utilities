...
#region Bounding Box Contains Point Filter Filter

# Create a Point
point = XYZ(0, 0, 0)

# This Filter accept a Inverse including true. This filter collects the elements which Bounding box contains a determinate Point
